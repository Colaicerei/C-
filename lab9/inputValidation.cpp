...
/***************************************************************************
** This function prompt user to input an int within range with a message.
***************************************************************************/ 	  
int promptIntInRange(std::string promptMsg, int min, int max)
{
	std::cout << promptMsg;
	int input;
	getIntInRange(&input, min, max);
	return input;
}
...
/***************************************************************************
** This function prompt user to input a string.
***************************************************************************/ 	  
std::string promptString(std::string promptMsg)
{
	std::cout << promptMsg;
	std::string input;
	std::getline(std::cin, input);
